...
## Inside CHK_COMM
CHK_COMM is located inside indoor PCB, the same location and address as RECEIV. it works really simple, if it detects the communcation cable, it will work, otherwise no. The error code for CHK_COMM is U4.
